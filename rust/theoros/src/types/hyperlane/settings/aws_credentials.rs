...
use rusoto_core::credential::{
    AutoRefreshingProvider, AwsCredentials, CredentialsError, EnvironmentProvider, ProvideAwsCredentials,
};
...
impl AwsChainCredentialsProvider {
    pub fn new() -> Self {
        ...
        let auto_refreshing_provider =
            AutoRefreshingProvider::new(WebIdentityProvider::from_k8s_env()).expect("Always returns Ok(...)");
