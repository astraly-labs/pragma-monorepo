...
impl CheckpointSyncer for GcsStorageClient {
    ...
    async fn write_latest_index(&self, index: u32) -> Result<()> {
        ...
        self.inner.insert_object(&self.bucket, LATEST_INDEX_KEY, d).await?;
        Ok(())
    }
...
async fn public_landset_no_auth_works_test() {
    ...
    const LANDSAT_KEY: &str =
        "LC08/01/001/003/LC08_L1GT_001003_20140812_20170420_01_T2/LC08_L1GT_001003_20140812_20170420_01_T2_B3.TIF";
    let client = GcsStorageClientBuilder::new(AuthFlow::NoAuth).build(LANDSAT_BUCKET, None).await.unwrap();
