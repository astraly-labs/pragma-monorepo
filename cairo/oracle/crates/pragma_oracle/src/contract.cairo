...
mod Oracle {
    ...
    struct Storage {
        ...
        //(source,(SPOT/FUTURES/OPTIONS/GENERIC), expiration_timestamp, and the pair_id) and the
        //list of publishers
        ...
        fn get_data_entry_for_publishers(
            ...
            match data_type {
                ...
                DataType::FutureEntry((
                    ...
                    let publishers = self
                        .get_publishers_for_source(source, FUTURE, pair_id, expiration_timestamp);
    ...
    impl OracleInternal of IOracleInternalTrait {
        ...
        fn get_latest_entry_timestamp(
            ...
            let (storage_bool, type_of_data, pair_id, expiration_timestamp) = match data_type {
                ...
                DataType::GenericEntry(key) => {
                    (
                        self.oracle_data_len_all_sources.entry((key, GENERIC, 0)).read(),
                        GENERIC,
                        key,
                        0
                    )
        ...
        fn build_entries_array(
            ...
            loop {
                ...
                let source: felt252 = *sources.get(cur_idx).unwrap().unbox();
                let publishers = self
                    .get_publishers_for_source(source, type_of_data, pair_id, expiration_timestamp);
